              ...
              eventContent={(eventInfo) => {
                return (
                  <div>
                    ...
                    <div className="ml-1">
                      {eventInfo.event.extendedProps.trainerName}
                    </div>
                    <div className="ml-1">
                      {eventInfo.event.extendedProps.customerName}
                    </div>
                    <div className="pt-3 ml-1">
                      {eventInfo.event.extendedProps.timeSpan}
                    </div>
                      ...
                      <div className="">
                        ...
                        <form action="submit" onSubmit={handleSubmit}>
                          ...
                          <input
                            ...
                            className={` ${
                              theme === "dark" ? "bg-gray-300" : "bg-white"
                            } block w-full rounded-md mt-2 border-0 py-1.5 text-gray-900
                            shadow-sm ring-1 ring-inset ring-gray-300 
                            ${
                              theme === "dark"
                                ? "placeholder:text-gray-500"
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      focus:ring-inset focus:ring-blue-300
                      sm:text-sm sm:leading-6`}
                              value={eventToUpdate.trainerName}
                              onChange={(e) => handleUpdateChange(e)}
                              placeholder="Enter trainer name"
                            />
                          </div>
                    ...
                    focus:ring-inset focus:ring-blue-300
                    sm:text-sm sm:leading-6`}
                            value={eventToUpdate.customerName}
                            onChange={(e) => handleUpdateChange(e)}
                            placeholder="Enter customer name"
                          />
                          <div
